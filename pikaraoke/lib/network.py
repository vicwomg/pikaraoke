...
def _get_ip_via_psutil() -> str:
    ...
    virtual_prefixes = (
        'lo', 'veth', 'docker', 'vmnet', 'vEthernet', 'VirtualBox',
        'WSL', 'Loopback', 'utun', 'awdl', 'bridge',
    )
        ...
        for addr in addrs:
            if addr.family == socket.AF_INET:  # IPv4
                ...
                if 'eth' in interface_lower or 'en' in interface_lower:
                    priority = 3
                elif 'wlan' in interface_lower or 'wi-fi' in interface_lower or 'wifi' in interface_lower:
                    priority = 2
                else:
                    priority = 1
