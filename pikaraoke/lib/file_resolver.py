...
class FileResolver:
    ...
    def handle_mp4_ass(self, file_path: str) -> bool:
        """Find and set the ASS subtitlefile path for an MP4 file.

        Searches for a ASS file with the same base name as the MP4.
