...
def launch_splash_screen(
    ...
    if karaoke.is_raspberry_pi:
        ...
        options.add_argument("--disable-features=VizDisplayCompositor")  # Reduce GPU compositor overhead
        ...
        options.add_argument("--disable-software-rasterizer")  # Force GPU rendering, no CPU fallback
        ...
        options.add_argument("--disable-backgrounding-occluded-windows")  # Don't suspend kiosk window
