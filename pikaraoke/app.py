...
def main():
    ...
    if not args.hide_splash_screen:
        ...
        try:
            ...
            print(
                f"[ERROR] Error starting splash screen. If you're running headed mode over SSH, you may need to run `export DISPLAY=:0.0` first to target the proper screen. Example: `export DISPLAY=:0.0; pikaraoke`"
            )
            # cherrypy.engine.exit()
            sys.exit()
